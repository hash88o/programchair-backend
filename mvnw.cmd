...
@REM Save the original PSModulePath to restore later
@SET __MVNW_PSMODULEP_SAVE=%PSModulePath%
@SET PSModulePath=

@REM Execute PowerShell to run the script and capture the command
...
# Unzip and move the downloaded distribution
